...
```bash
python3 skills/find-examples/scripts/github_search.py <dependency> --lang <lang1,lang2> --limit 5
```

**Example (Genkit Go/JS):**
```bash
python3 skills/find-examples/scripts/github_search.py "genkit" --lang "go,typescript"
```
...
Once cloned, use `list_files`, `read_file`, or `grep_search` to find relevant implementation details.

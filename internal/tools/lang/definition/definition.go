// Package definition implements the find_definition tool via LSP.
package definition
...
func Register(mcpServer *mcp.Server, s Server) {
	def := toolnames.Registry["find_definition"]
...
// Params defines the input parameters for the find_definition tool.
type Params struct {
